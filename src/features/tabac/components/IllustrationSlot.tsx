...
interface IllustrationSlotProps {
  /** Identifiant du fichier attendu dans public/illustrations/tabac/<id>.png */
  id: string;
...
/**
 * Emplacement d'illustration du thème tabac. Aucune image n'existe encore : le
 * placeholder (tuile crème, bord fin, libellé centré) est l'état normal, pas une
 * erreur — il sera automatiquement remplacé dès que public/illustrations/tabac/<id>.png
