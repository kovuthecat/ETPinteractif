...
| **Ma méthode patch** | Substituts (X3, étendue X8) | référence + photographie | Les 3 règles (« + ¼ tous les 2-3 jours si l'envie persiste et pas de signe de surdosage » · « signes de surdosage → revenir à la dose précédente » · « sommeil perturbé → dose de nuit plus faible ») + **ma dose du moment** (quarts dessinés en vert, jour et nuit si activé — le jour affiche en plus une **marge de quarts vides à colorier** : le patch en cours complété + 1 patch entier, pour la montée de dose à la maison) + signes de surdosage listés. Bloc optionnel **« Ma prise ponctuelle »** : sélecteur dédié à la fiche (gomme/pastille/sublingual/spray, indépendant de la forme explorée à l'écran) affichant l'illustration de technique (image-ready, placeholder tant qu'aucune image n'est fournie) + les bonnes pratiques de la forme choisie. Aucun mg. |
