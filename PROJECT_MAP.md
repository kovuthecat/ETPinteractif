...
src/
  ...
  features/
    ...
    cardio/
      ...
      tabac/TabacModule.tsx / .module.css          # Module 6 — Le tabac : curseur Fumeur→Arrêté à 5 repères montrant le
                                                     # mécanisme CV (paroi agressée→spasme→plaque→caillot→réversibilité) sur
                                                     # l'artère héros partagée (ArtereCoupe, réutilisée) ; remplace la bascule
                                                     # 2 états (A8, refonte-audit-2026-07 S6, 2026-07-24, gate G-A8 levée) ;
                                                     # pont vers le thème Tabac conservé
