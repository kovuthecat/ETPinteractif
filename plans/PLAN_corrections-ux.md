...
- **Statut :** [x] fait (récit proposé — paramètres illustratifs à valider par Thibault, cf. `VALIDATION.md`)
...
- **Statut :** [x] fait - Codex, 2026-06-28, commit `feat(module): affiche interactive toxiques vs nicotine`
