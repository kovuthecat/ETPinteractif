...
Audit réalisé sur `https://etp-interactif.vercel.app/` avec Chromium/Playwright, thème **Diabète** uniquement. Captures et JSON de preuve : `output/playwright/audit-diabete/`. Viewports testés : `1440x900` et `1024x768`.
...
- **Gravité : important | Axe : pédagogie/ergonomie**  
  Étapes : ouvrir le module, cliquer "Insulinopénie", "Insulinorésistance", "Mixte", attendre la fin de l'animation. Capture : `output/playwright/audit-diabete/01-mecanisme-modes-final.png`.  
...
- **Gravité : mineur | Axe : lisibilité**  
  Étapes : passer en `1024x768`. Capture : `output/playwright/audit-diabete/01-mecanisme-1024-fast.png`.  
...
- **Gravité : important | Axe : lisibilité/pédagogie**  
  Étapes : ouvrir Alimentation, lire les cartes du garde-manger ou interroger les noms accessibles des boutons. Capture : `output/playwright/audit-diabete/02-alimentation-empty-fast.png`.  
...
- **Gravité : important | Axe : ergonomie**  
  Étapes : ouvrir l'état initial à `1440x900`. Capture : `output/playwright/audit-diabete/02-alimentation-empty-fast.png`.  
...
- **Gravité : important | Axe : accessibilité/ergonomie**  
  Étapes : ouvrir Activité physique, onglet "Timing", choisir "Micro-coupures", cliquer quelques coupures, passer en `1024x768`. Capture : `output/playwright/audit-diabete/03-activite-timing-micro.png`.  
...
- **Gravité : important | Axe : accessibilité/ergonomie**  
  Étapes : ouvrir le module, état initial. Capture : `output/playwright/audit-diabete/04-risque-cardio-empty.png`.  
...
- **Gravité : important | Axe : ergonomie/pédagogie**  
  Étapes : ouvrir le module, observer l'état initial. Capture : `output/playwright/audit-diabete/05-complications-empty.png`.  
...
- **Gravité : important | Axe : ergonomie/lisibilité**  
  Étapes : ouvrir Suivi à `1024x768`. Capture : `output/playwright/audit-diabete/06-suivi-1024-fast.png`.  
...
- **Gravité : important | Axe : ergonomie/lisibilité**  
  Étapes : ouvrir Traitements à `1024x768`. Capture : `output/playwright/audit-diabete/07-traitements-1024-fast.png`.  
...
- **Gravité : important | Axe : pédagogie/lisibilité**  
  Étapes : ouvrir le module, état "Mon profil hypo". Capture : `output/playwright/audit-diabete/08-hypoglycemie-empty.png`.  
...
- **Gravité : important | Axe : lisibilité/pédagogie**  
  Étapes : ouvrir Insuline. Capture : `output/playwright/audit-diabete/09-insuline-empty.png`.  
