...
### Composants / modules
- 4 stubs de modules restants (« À venir ») reliés au registre : `addiction`, `substituts`, `nicotine-toxique`, `craving` (T2).
...
- Modules 1, 3, 4, 6 pas encore implémentés (stubs « À venir »). Reste à faire : T8-T11.
...
1. T1–T7 faits (scaffolding, types/registre/navigation, coquille/sources/carte, carte centrale, utilitaire de courbe, Module 2, Module 5). Poursuivre `PLAN_modules-tabac.md` à partir de T8 (Module 1 — composantes de l'addiction).
