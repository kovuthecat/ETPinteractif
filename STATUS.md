...
**Phase 2 — Corrections UX (audit du 28/06, `PLAN_corrections-ux.md`) : en cours.** C1 (socle visuel sémantique), C2 (titration substituts illimitée + patchs 2×2) faits. Reste C3-C10.
...
1. **Lot `PLAN_corrections-ux.md` en cours.** C1, C2 faits. Suite recommandée par le plan : C3 → C5 → C6 → C9 → C8 → C4 → C7 → C10.
